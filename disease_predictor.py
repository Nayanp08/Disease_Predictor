...
w2 = Label(root, justify=CENTER, text="Team : Nayan, Sailee", fg="white", bg="black")
w2.config(font=("Brush Script MT", 20))
w2.grid(row=2, column=0, columnspan=2, padx=100)

# labels
NameLb = Label(root, text="Name of the Patient", fg="red", bg="black")
NameLb.grid(row=8, column=0, pady=15)
...
lrLb.grid(row=16, column=0, pady=10)
lrLb.config(font=("Elephant", 15))

destreeLb = Label(root, text="RandomForest", fg="white", bg="red")
destreeLb.grid(row=18, column=0, pady=10)
destreeLb.config(font=("Elephant", 15))

ranfLb = Label(root, text="NaiveBayes", fg="white", bg="red")
ranfLb.grid(row=20, column=0, pady=10)
ranfLb.config(font=("Elephant", 15))
# entries
OPTIONS = sorted(l1)

NameEn = Entry(root, textvariable=Name)
NameEn.grid(row=8, column=1)
...
dst.grid(row=9, column=2)
dst.config(font=("Elephant", 13))

rnf = Button(root, text="Randomforest", command=randomforest,bg="green",fg="yellow")
rnf.grid(row=11, column=2,padx=10)
rnf.config(font=("Elephant", 13))

lr = Button(root, text="NaiveBayes", command=NaiveBayes,bg="green",fg="yellow")
lr.grid(row=13, column=2,padx=10)
lr.config(font=("Elephant", 13))
